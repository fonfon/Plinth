...
from plinth.modules import PlinthModuleManager
...
# customize the module manager name if it is different from 'ModuleManager'
# module_manager_name = 'AnotherModuleManager'


class ModuleManager(PlinthModuleManager):
    """
    Example usage of a ModuleManager (without much customization)
    """
    version = 1
