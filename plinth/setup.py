...
class ModuleSetup(object):
    """
    Setup functionality for a module (same as the Helper class below).

    It provides all setup-related functionality and information of a module,
    and is accessible via a ModuleManager instance: <module_manager>.setup
    """
...
# setup_modules and list_dependencies could/should be part of the Modules class
